...
export const translations = {
  en: {
    ...
    pricing: {
      ...
      faqA2:
        'Yes. Pro is a monthly subscription. You can manage or cancel it at any time from the billing portal.',
      faqQ3: 'What happens if I go over a Free limit?',
      faqA3:
        "You can upgrade to Pro when you reach a Free limit. Nothing you've already logged is ever deleted or hidden.",
    },
    plan: {
      ...
      cancelConfirmTitle: 'Cancel your Pro plan?',
      cancelConfirmDescription:
        'Your Pro access will remain active until the end of the current billing period. After that, your account will return to the Free plan.',
      cancelKeep: 'Keep Pro',
      cancellingPlan: 'Cancelling…',
      cancelSuccess: 'Your Pro plan was scheduled for cancellation.',
      cancelError: 'Could not cancel your Pro plan. Please try again.',
      cancellationPendingDescription:
        'Your Pro access is available until {date}.',
    ...
    overview: {
      ...
      addExpenseCta: 'Record an expense',
      addTransactionCta: 'Record a transaction',
    ...
    accounts: {
      ...
      logoTooLarge: 'The logo could not be compressed below 1 MB.',
      icon: 'Icon',
  ...
  es: {
    ...
    pricing: {
      ...
      faqA2:
        'Sí. Pro es una suscripción mensual. Podés administrarla o cancelarla en cualquier momento desde el portal de cobros.',
      faqQ3: '¿Qué pasa si supero un límite del plan Free?',
      faqA3:
        'Podés actualizar a Pro cuando llegues a un límite del plan Free. Nada de lo que ya registraste se borra ni se oculta.',
    },
    plan: {
      ...
      manageBilling: 'Administrar cobros',
      cancelPlan: 'Cancelar plan Pro',
      cancellationPending: 'Cancelación programada',
      cancelConfirmTitle: '¿Cancelar tu plan Pro?',
      cancelConfirmDescription:
        'Tu acceso Pro seguirá activo hasta el final del periodo de cobro actual. Después, tu cuenta volverá al plan Free.',
      cancelKeep: 'Mantener Pro',
      cancellingPlan: 'Cancelando…',
      cancelSuccess: 'La cancelación del plan Pro fue programada.',
      cancelError: 'No se pudo cancelar el plan Pro. Intentá de nuevo.',
      cancellationPendingDescription:
        'Tu acceso Pro está disponible hasta el {date}.',
      openingCheckout: 'Abriendo checkout…',
      openingBilling: 'Abriendo cobros…',
      checkoutError: 'No se pudo abrir el checkout. Intentá de nuevo.',
      billingError: 'No se pudo abrir la facturación. Intentá de nuevo.',
    },
    blog: {
      eyebrow: 'Blog',
    ...
    overview: {
      ...
      addExpenseCta: 'Registrar un gasto',
      addTransactionCta: 'Registrar una transacción',
      ...
      setupBudgetCta: 'Configurar presupuesto',
    ...
    accounts: {
      ...
      logoTooLarge: 'No se pudo comprimir el logo por debajo de 1 MB.',
      icon: 'Ícono',
